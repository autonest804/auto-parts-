...
export default function GMap({
  ...
  const handleNavigate = (e?: React.MouseEvent) => {
    ...
    // Standard Google Maps navigation scheme (will launch native Maps app on mobile if installed)
    const url = `https://www.google.com/maps/dir/?api=1&destination=${coords.lat},${coords.lng}`;
    
    // Using "_system" is the standard Capacitor/Cordova target to trigger the native app chooser
