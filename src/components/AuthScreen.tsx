  ...
  return (
    <div className="flex-1 flex flex-col bg-slate-900 justify-center text-slate-100 overflow-y-auto px-6 py-12 relative" id="auth-screen-container">
      ...
      <div className="flex flex-col items-center text-center mt-4">
        {/* Launcher Icon: Blue background with white logo */}
        <div className="w-20 h-20 bg-indigo-600 rounded-3xl flex items-center justify-center shadow-lg shadow-indigo-600/30 mb-6 animate-pulse border border-white/20">
        ...
        <h2 className="text-3xl font-extrabold tracking-tight text-white">
          Auto <span className="text-indigo-400">Parts</span>
        </h2>
